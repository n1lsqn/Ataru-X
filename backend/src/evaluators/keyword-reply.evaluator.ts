...
@Injectable()
export class KeywordReplyEvaluator implements ConditionEvaluator {
  readonly type = ConditionType.KEYWORD_REPLY;
  ...
  async evaluate(
    ...
    // Simulation: 30% chance participant replied with the keyword
